...
try:
	...
	os.system('pip2 install requests;pip2 install colorama;pkg install random;python3 rfb.py')
...
|__/|__/         | $$ /$$__  $$ |____  $$| $$_  $$_  $$      | $$$$$$$   /$$$$$$/  | $$        |__/|__/
                 ...
                 | $$| $$_____/ /$$__  $$| $$ | $$ | $$       /$$  \ $$| $$        | $$
                 | $$|  $$$$$$$|  $$$$$$$| $$ | $$ | $$      |  $$$$$$/| $$$$$$$$ /$$$$$$
                 |__/ \_______/ \_______/|__/ |__/ |__/       \______/ |________/|______/
...
ff = '''\033[91m ________________________________
 |  \033[91m                          |
 | [1] Crack faecbook (\033[32mspeed\x1b[1;91m)    |
 | [2] Crack faecbook (\033[93mNo speed\x1b[1;91m) |
 | [3] Crack faecbook (\033[34mfree\x1b[1;91m)     |
 | [4] Crack fb pakistan (\033[32mspeed\x1b[1;91m) |
 | [5] Crack fb india (\033[32mspeed\x1b[1;91m)    |
 | [6] Crack Email  (\033[32mspeed\x1b[1;91m)      |
 | [7] Crack fb-old (\033[32mspeed\x1b[1;91m)      |
 | [8] View TikTok  (\033[32mspeed\x1b[1;91m)      |
 | [9] Crack Cart (\033[32mspeed\x1b[1;91m)        |
 | [10] Crack Pubg  (\033[32mspeed\x1b[1;91m)      |
 | [11] Crack list-pass (\033[32mspeed\x1b[1;91m)  |
 | [12] Crack fb-id (\033[32mspeed\x1b[1;91m)      |
 | [13] Faecbook-Close (\033[32mspeed\x1b[1;91m)   |
 |_______________________________|
'''
cp = ' \x1b[1;97m[\033[93mCP\x1b[1;97m]'
ok = ' \x1b[1;97m[\033[32mOK\x1b[1;97m]'
...
def pasowrd():
	...
	if username=='hama' and passowrd=='cracker':
		ukl = open('.save/active.txt', 'r')
		for kj in ukl:
			spk = kj.split()
			chat_login = '[=] Tool Ragnarok\n[=] iD '+str(spk)+'\n[=] Time '+str(datetime.now())
		ukl.close()
		...
		for s in idd.split():
			print(s)
			if s == sp[0]:
				lk('\033[32m login Ragnarok and conect tools Ragnar , get python3')
				time.sleep(0.9)
				...
				print(logo2)
				print(' Bo iD active krd msg bnera la telegram > \033[31mi4m_Ragnar')
...
def crack_id():
	...
	lk('\033[36m time...')
	lk('\x1b[1;97m by channal > \033[31mRagnar521 &Ragnar404')
	print(logo2)
...
def crack_pas():
	...
	lk('\033[36m time...')
	lk('\x1b[1;97m by channal > \033[31mRagnar 404')
	print(logo2)
